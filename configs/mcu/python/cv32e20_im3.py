...
def config():
    ...
    system.set_cpu(cv32e20(rv32e=False, rv32m="RV32MSingleCycle"))
    ...
    user_peripheral_domain.add_peripheral(RV_plic())
    user_peripheral_domain.add_peripheral(SPI_host())
    user_peripheral_domain.add_peripheral(GPIO())
    user_peripheral_domain.add_peripheral(I2C())
    user_peripheral_domain.add_peripheral(RV_timer())
    user_peripheral_domain.add_peripheral(SPI2())
    user_peripheral_domain.add_peripheral(UART())
    user_peripheral_domain.add_peripheral(I2S())  # If no address is provided, the peripheral will be automatically added where there is space.
